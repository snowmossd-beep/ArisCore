...
public class ArisCore extends JavaPlugin {
    ...
    private RtpQueueModule rtpQueueModule;
    ...
    public void onEnable() {
        ...
        rtpQueueModule = new RtpQueueModule(this);
        if (isModuleEnabled("rtpqueue")) rtpQueueModule.enable();
        ...
        if (isModuleEnabled("combat")) combatModule.enable();
        ...
        getLogger().info("ArisCore enabled! Modules: TPA, RTP, RtpQueue, Home, Shop, Shards, Team, Auction, Sell, Tab, Order, Spawn, AFK, Warp, Crates, Amethyst, Duel, Spawners, Combat");
    }
    ...
    public void onDisable() {
        ...
        if (rtpQueueModule != null) rtpQueueModule.disable();
        ...
        if (combatModule != null) combatModule.disable();
    }
    ...
    public RtpQueueModule getRtpQueueModule() { return rtpQueueModule; }
