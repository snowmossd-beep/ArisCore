...
public class CrateCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "delete" -> {
                ...
                handleDeleteCrate(sender, args[1]);
            }
    ...
    private void handleDeleteCrate(CommandSender sender, String crateName) {
        ...
        FoliaUtil.runAsync(module.getPlugin(), () -> {
            module.getCrateConfigManager().removeAllLocations(crate);
            module.getCrateConfigManager().deleteCrateFile(crateName);
        });

        module.getCrateRegistry().remove(crateName);
        msg.send(sender, "crate-deleted", "{crate}", crateName);
    }
    ...
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command,
                                      @NotNull String label, @NotNull String[] args) {
        if (args.length == 1) {
            return Arrays.asList("reload", "givekey", "takekey", "create", "movehere", "edit", "delete").stream()
        ...
        if (args.length == 2) {
            ...
            if (args[0].equalsIgnoreCase("movehere") || args[0].equalsIgnoreCase("edit") || args[0].equalsIgnoreCase("delete")) {
