...
public class ArisCoreReloadCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        switch (module) {
            ...
            case "rtpqueue" -> reloadOne(sender, "rtpqueue", "RtpQueue", plugin.getRtpQueueModule());
            case "combat" -> reloadOne(sender, "combat", "Combat", plugin.getCombatModule());
            default -> {
                ...
                reloadOne(sender, "rtpqueue", "RtpQueue", plugin.getRtpQueueModule());
                reloadOne(sender, "combat", "Combat", plugin.getCombatModule());
    ...
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command,
                                      @NotNull String label, @NotNull String[] args) {
        if (args.length == 1) {
            return Arrays.asList("all", "tpa", "home", "shop", "shards", "team", "auction", "sell", "tab", "order", "spawn", "afk", "warp", "crates", "amethyst", "duel", "spawners", "rtpqueue", "combat").stream()
